...
% Test Data
TestOutputs=evalfis(fis,data.TestInputs);
PlotResults(data.TestTargets,TestOutputs,'Test Data');
TrainIn = data.TrainInputs;
TestIn = data.TestInputs;
TrainTa = data.TrainTargets;
TestTa = data.TestTargets;
save("DataFisl.mat","TrainIn","TestIn","TrainTa","TestTa")
writeFIS(fis,"insectFisl")
